          ...
          style: ButtonStyle(
            backgroundColor: WidgetStateProperty.resolveWith<Color>(
              (Set<WidgetState> states) {
                ...
                return Color(0xffFF8702); // Цвет для активного состояния
              },
            ),
            ...
            foregroundColor: WidgetStateProperty.resolveWith<Color>(
              (Set<WidgetState> states) {
                if (states.contains(WidgetState.disabled)) {
                  return Color(
                      0xffBCBCBF); // Цвет текста для неактивного состояния
                }
                return Colors.white; // Цвет текста для активного состояния
              },
            ),
          ),
          child: const Text(
